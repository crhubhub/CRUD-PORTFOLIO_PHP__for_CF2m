...
<section class="page-section" id="header-manage">
    <div class="container-fluid">
        <table class="table text-center">
            ...
            <?php for ($i = 0; $i < count($messagesArray); $i++) : ?>
<!--                if ($messagesArray[$i]->getArchived() = true) : -->
                <tr class="bg-light">
                   ...
                   <td colspan="6" class="align-middle"><?=$messagesArray[$i]->getMessageTxt() ?>
                    ...
                    <td class="align-middle"><?=$messagesArray[$i]->getDate() ?></td>
                      <td class="align-middle"><a href="" class="btn bg-success
                     text-light">Archive</a></td>
                     <td class="align-middle"><a href="" class="btn bg-danger text-light">Delete</a></td>
            </tr>
<!--            --><?php //endif ?>
            <?php endfor?>
        </table>
        <p class="m-auto text-center"><a href="am-admin">Manage archived messages</a></p>
    </div>
</section>
